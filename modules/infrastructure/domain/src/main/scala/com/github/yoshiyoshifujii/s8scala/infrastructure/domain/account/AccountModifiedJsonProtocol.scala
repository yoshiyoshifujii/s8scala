package com.github.yoshiyoshifujii.s8scala.infrastructure.domain.account

import com.github.yoshiyoshifujii.s8scala.domain.account.{AccountId, AccountModified}
import spray.json._
